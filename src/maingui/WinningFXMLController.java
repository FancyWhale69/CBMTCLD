...
public class WinningFXMLController implements Initializable {

    @FXML
    Label score;//show score
    
    @FXML
    Label time;//show time
    
    
    static int scor, tim;//get values from test
    //----------------------------------------------------------------------------------//-----------------------------------------------------------------
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        //set values to labelss
        score.setText(scor+"");
        time.setText(TestSystem.returnTimeMinute(tim));
    }    
    //----------------------------------------------------------------------------------//-----------------------------------------------------------------
}
